    ...
    return (
      <input
        ...
        className={cn(
          ...
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background", // Keep standard focus for accessibility
          "disabled:cursor-not-allowed disabled:opacity-50",
          "transition-colors duration-200 ease-in-out", // Add transition
          "shadow-inner bg-opacity-80 backdrop-blur-sm", // Subtle inner shadow and transparency
          "md:text-sm",
          className
        )}
        ref={ref}
